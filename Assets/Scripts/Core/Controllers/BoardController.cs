...
namespace Assets.Scripts.Core.Controllers
{
    ...
    {
        [SerializeField]
        private GameObject gameTable = default;
        ...
        public void Init(SettingsService settingsService, StateService stateService)
        {
        ...
        {
            //без этого доска летает над столом
            //TODO: убрать 
            InitChessBoard();

            var currentFenMatrix = stateService.GetNewFenMatrix();
        ...
        private void InitChessBoard()
        {
            ...
            (bounds, _) = GetObjectRendererParams(gameObject);
